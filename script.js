document.addEventListener('DOMContentLoaded', () => {
    ...
    // MODIFIED: Removed About Section Reveal logic
    // const aboutSection = document.getElementById('about');
    // const aboutHeading = aboutSection.querySelector('.section-heading');
    // const aboutParagraphs = aboutSection.querySelectorAll('p');
    // const aboutTags = aboutSection.querySelector('.tags'); 
    // aboutHeading.classList.add('hidden-initial-reveal');
    // aboutParagraphs.forEach(p => p.classList.add('hidden-initial-reveal'));
    // if (aboutTags) {
    //     aboutTags.classList.add('hidden-initial-reveal');
    // }
    // const aboutObserver = new IntersectionObserver((entries, observer) => {
    //     entries.forEach(entry => {
    //         if (entry.isIntersecting) {
    //             setTimeout(() => { aboutHeading.classList.add('reveal-text'); }, 100);
    //             setTimeout(() => { aboutParagraphs.forEach(p => p.classList.add('reveal-text')); }, 600);
    //             setTimeout(() => { if (aboutTags) { aboutTags.classList.add('reveal-text'); } }, 1200);
    ...
    // MODIFIED: Removed Projects Section Reveal logic
    // const projectsHeading = projectsSection.querySelector('.section-heading');
    // const projectsGridElements = projectsGrid.children; 
    // projectsHeading.classList.add('hidden-initial-reveal');
    // const projectsObserver = new IntersectionObserver((entries, observer) => {
    //     entries.forEach(entry => {
    //         if (entry.isIntersecting) {
    //             setTimeout(() => { projectsHeading.classList.add('reveal-text'); }, 100);
    //             let delay = 600;
    //             for (let i = 0; i < projectsGridElements.length; i += 2) {
    //                 setTimeout(() => {
    //                     if (projectsGridElements[i]) { projectsGridElements[i].classList.add('reveal-text'); }
    //                     if (projectsGridElements[i + 1]) { projectsGridElements[i + 1].classList.add('reveal-text'); }
    //                 }, delay);
    //                 delay += 400;
    //             }
    //             observer.unobserve(entry.target);
    ...
    // Ensure About and Projects sections are visible by default
    // No need for explicit reveal-text if hidden-initial-reveal is removed.
    // The elements will be visible by default as they are not hidden by JS/CSS anymore.
